...
public class RecursionUtils {
    /**
     * Merges two non-arrays which do not contain null elements and are sorted in
     * ascending-order.
     *
     * @param arr1 the first array, sorted in ascending order
     * @param arr2 the second array, sorted in ascending order
     * @return an array containing all the elements of arr1 and arr2, sorted in
     *         ascending order
     ...
     *
     * The initial index of the range (start) must lie in the range [0,
     * original.length].
     * The final index of the range (end) must lie in the range [start,
     * original.length].
     *
     * The value at original[start] is placed into the initial element of the copy
     * (unless start == original.length or start == end). Values from subsequent
     * elements
